...
/**
 * Route definition for delete organization endpoint
 */
export const deleteOrganizationRoute: RouteDefinition = {
    method: 'DELETE',
...
/**
 * Delete organization handler factory
...
/**
 * Complete handler package for delete organization
