...
```bash
npm install @multitenantkit/core \
  @multitenantkit/adapters-drizzle-pg \
  @multitenantkit/adapters-supabase-auth \
...
console.log('✅ MultiTenantKit initialized successfully!');
